...
static struct omap_opp sholes_mpu_rate_table[] = {
	{0, 0, 0},
	/*OPP1*/
	{CONFIG_SHOLES_FREQ_1, VDD1_OPP1, CONFIG_SHOLES_VSEL_1},
	/*OPP2*/
	{CONFIG_SHOLES_FREQ_2, VDD1_OPP2, CONFIG_SHOLES_VSEL_2},
	/*OPP3*/
	{CONFIG_SHOLES_FREQ_3, VDD1_OPP3, CONFIG_SHOLES_VSEL_3},
	/*OPP4*/
